...
@bp.route('/cases/<case_id>/nodes/<node_id>', methods=['PUT'])
@jwt_required()
...
@bp.route('/cases/<case_id>/status', methods=['GET'])
@jwt_required()
...
@bp.route('/cases/<case_id>/feedback', methods=['GET'])
@jwt_required()
...
@bp.route('/cases/<case_id>/feedback', methods=['PUT'])
@jwt_required()
