...
@vector_bp.route('/status', methods=['GET'])
...
@vector_bp.route('/test', methods=['POST'])
...
@vector_bp.route('/documents/<document_id>', methods=['DELETE'])
...
@vector_bp.route('/embedding/test', methods=['POST'])
def test_embedding():
    """测试嵌入服务"""
    try:
        data = request.get_json()
...
@vector_bp.route('/config', methods=['GET'])
